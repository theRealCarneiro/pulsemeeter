from meexer.clients.gtk.widgets.device.device_box_widget import DeviceBoxWidget
from meexer.clients.gtk.adapters.main_window_adapter import MainWindowAdapter
